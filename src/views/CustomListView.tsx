...
// import "./index.scss";
import ListIcon from "../graphics/ListIcon";
import GridIcon from "../graphics/GridIcon";

const baseClass = "collection-list";

const CustomListView: React.FC<Props> = (props) => {
  const {
    collection: {
      admin: {
        components: {
